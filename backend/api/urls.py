...
from .views import RegisterView, CurrentUserView, TextbookViewSet, ListingViewSet, BookshopViewSet, SchoolViewSet, SchoolBookListsView, ConversationListView, MessageListView, FindOrCreateConversationView, CartView, ReviewViewSet, UserReviewsView, MyListingsView, MyBookListsView, MyProfileView
#router
